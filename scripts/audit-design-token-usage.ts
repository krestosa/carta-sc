// Documenta la tarea audit design token usage utilizada por la compilación, auditoría o comprobación del proyecto.
...
const LEGACY_REFERENCES: ReadonlyArray<readonly [string, RegExp]> = [
  ...
  ['legacy-motion-alias', /--sc-motion-micro\b/g],
  ['legacy-component-token-path', /\bcomponent\.(?:color|dimension|number|duration|shadow)\.[A-Za-z0-9_.]+/g],
  ['legacy-z-alias', /--sc-z-[\w-]+\b/g],
  ['legacy-radius-alias', /--sc-radius-[\w-]+\b/g],
