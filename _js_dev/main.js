...
(function () {
	...
	addBlockingCss('sc-catalog-css', 'overrides/catalog.css?v=20260814-1316-spacing');
	addBlockingCss('sc-category-nav-css', 'overrides/category-nav.css?v=20260814-1316-spacing');
	addBlockingCss('sc-loading-skeleton-css', 'overrides/loading-skeleton.css?v=20260814-1316-spacing');
	addBlockingCss('sc-catalog-prepaint-css', 'overrides/prepaint.css?v=20260814-1316-spacing');
	addBlockingCss('sc-motion-css', 'motion/motion.css?v=20260814-1316-spacing');
	addBlockingCss('sc-catalog-type-grid-css', 'overrides/catalog-type-grid.css?v=20260814-1316-spacing');
	addBlockingCss('sc-product-image-ratio-css', 'overrides/product-image-ratio.css?v=20260814-1316-spacing');
	addBlockingCss('sc-card-hierarchy-css', 'overrides/card-hierarchy.css?v=20260814-1316-spacing');

	var script = document.createElement('script');
	script.src = 'overrides/catalog.js?v=20260814-1316-spacing';
	script.async = false;
	document.head.appendChild(script);

	var metaScript = document.createElement('script');
	metaScript.src = 'overrides/product-meta-layout.js?v=20260814-1316-spacing';
...
(function () {
	...
	var script = document.createElement('script');
	script.src = 'motion/motion.js?v=20260814-1316-spacing';
	script.async = true;
	document.head.appendChild(script);
})();