...
function requestCenter(){if(document.body.classList.contains('sc-catalog-searching')){scheduleRail();return;}var scroller=mobileScroller();if(!N.mq.matches&&scroller)P.centerActive(scroller);scheduleRail();}
