/* Mantiene visible la categoría activa con la misma política de scroll del tab bar. */
(function(){
'use strict';
...
function hasFocusedTab(scroller){return!!(scroller&&scroller.querySelector('a.anchorLink:focus-within'));}
