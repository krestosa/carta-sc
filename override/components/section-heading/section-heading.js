...
var initialized=false,pending=false,motionDeps=null,generation=0,firstRaf=0,secondRaf=0,elements=[],splits=[],tweens=[],RULE_PROPERTY='--sc-section-rule-scale',CFG={ruleDuration:.72,textDuration:.52,textStagger:.045,triggerStart:'clamp(top 90%)',lineOffsetPercent:105},REFRESH_DELAY=60;
