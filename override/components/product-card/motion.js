/* Orquesta el reveal in-view de tarjetas por breakpoint. La visibilidad real la decide
   IntersectionObserver; los perfiles sólo ajustan umbral y recorrido corto. */
(function(){
'use strict';
...
var installed=false,reflowRaf=0,PROFILES={
  mobile:{threshold:.04,initialY:4,revealY:6},
  tablet:{threshold:.05,initialY:4,revealY:7},
  desktop:{threshold:.06,initialY:5,revealY:8}
};
