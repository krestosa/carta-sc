...
var installed=false,reflowRaf=0;
function reflow(){
...
function install(){
  ...
  SC.motion.whenReady(function(deps){
    ...
    mm.add({reduceMotion:C.media.reducedMotion},function(ctx){return parts.setupReveal?parts.setupReveal(gsap,ST,!!ctx.conditions.reduceMotion):function(){};});
  });
}
