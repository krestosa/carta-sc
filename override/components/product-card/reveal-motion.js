...
parts.setupReveal=function(gsap,ST,profile,reduce){
  ...
  /* Nunca anima contenido ya visible al cargar; solo prepara tarjetas realmente diferidas. */
  ...
  if(deferred.length){
    ...
    /* Un rescate tardío corrige cards que entraron al viewport antes de que disparara su batch. */
