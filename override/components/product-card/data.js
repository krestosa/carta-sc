...
var each=U.each,text=U.text,TRAITS_LABEL_PREFIX='Características: ';
...
function buildTraitGroup(card,className){
  ...
  var group=T.clone('product-trait-group');group.className=className||S.productTraits.slice(1);
...
SC.productCardData={imageSource:imageSource,cleanPriceText:cleanPriceText,ensureId:ensureId,traitLabels:traitLabels,buildTraitGroup:buildTraitGroup,traitsLabelPrefix:TRAITS_LABEL_PREFIX};
})();
